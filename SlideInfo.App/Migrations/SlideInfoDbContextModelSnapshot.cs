...
namespace SlideInfo.App.Migrations
{
    ...
    partial class SlideInfoDbContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SlideInfo.App.Models.Conversation", b =>
                {
            ...
            modelBuilder.Entity("SlideInfo.App.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SlideInfo.App.Models.Slide", b =>
                {
                    ...
                    b.Property<bool>("HasAssociatedImages");
            ...
            modelBuilder.Entity("SlideInfo.App.Models.Comment", b =>
                {
                    b.HasOne("SlideInfo.App.Models.AppUser", "AppUser")
                        .WithMany("Comments")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SlideInfo.App.Models.Slide", "Slide")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("SlideInfo.App.Models.Message", b =>
                {
                    b.HasOne("SlideInfo.App.Models.AppUser", "From")
                        .WithMany()
                        .HasForeignKey("FromId");

                    b.HasOne("SlideInfo.App.Models.Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("Subject");

                    b.HasOne("SlideInfo.App.Models.AppUser", "To")
                        .WithMany()
                        .HasForeignKey("ToId");
                });
